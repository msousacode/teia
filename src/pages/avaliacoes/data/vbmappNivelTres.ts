      ...
      objetivos: [
        {
          ...
          cod: 11,
          descricao:
            'Emite inflexão de nome ao combinar a raiz de 10 substantivos com sufixos para o plural(ex. cachorro vs cachorro) e 10 pronomes possessivos ( ex. dele, dela, meu, seu). (O/T). nominais combinando 10 substantivos originais com sufixos plurais (ex. cachorro vs.',
          selected: null,
        },
        {
          id: 356,
          cod: 12,
          descricao:
            'Emite inflexões verbo ao combinar 10 verbos com sufixo para passado simples (Ex. comeu) e 10 para futuro simples (ex: comerá). (O/T).',
          selected: null,
        },
        {
          id: 357,
          cod: 13,
          descricao:
            'Emite 10 frases diferentes com substantivos que contenham pelo menos 3 palavras com 2 modificadores (adjetivos, preposições, pronomes)(" Esta é minha boneca" " Eu quero sorvete de chocolate"). (O/T).',
          selected: null,
        },
        {
          id: 358,
          cod: 14,
          descricao:
            'Emite 10 frases com verbos que contenham pelo menos 3 palavras e modificadores (ex. advérbios, preposições, pronomes) (ex. "Empurra com força" "Fique em cima dos degraus".) (O/T)',
          selected: null,
        },
        {
          id: 359,
          cod: 15,
          descricao:
            'Combina frase com substantivo e verbo para produzir 10 sentenças diferentes, sintaticamente corretas, contendo pelo menos 5 palavras (ex. "O cachorro lambeu minha cara") (O/T)',
          selected: null,
        },
      ],
    },
...

    {
      ...
      objetivos: [
        ...
        },
        {
          ...
          cod: 13,
          descricao:
            'Retira a quantidade correta de itens entre 1 e 5 de um conjunto com quantidade maior solicitada a fazê lo (ex.: "Pegue 4 carros". "Agora me dê 2 carros".) (T)',
          selected: null,
        },
        {
          id: 369,
        ...
        },
        {
          ...
          cod: 15,
          descricao:
            'Corretamente combina um número escrito com à quantidade e a quantidade com um número escrito para os números de 1 a 5 (ex.: combinar o número 3 a uma figura que mostra 3 caminhões). (T)',
          selected: null,
        },
      ],
    },
