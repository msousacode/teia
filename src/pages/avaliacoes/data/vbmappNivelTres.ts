      ...
      objetivos: [
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança responde uma instrução complexa que requer dela atenção a um item específico e a propriedade deste item por cor ou forma).',
            materiais:
              'Uma lista de cores, formas e uma coleção de formas coloridas diferentes.',
            exemplo:
              'Quando um adulto diz, “Onde esta a caneca azul?” a criança seleciona a caneca azul de um arranjo que também contém um chapéu azul, uma caneca vermelha, um prato azul, etc.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela selecionar itens por cor e forma de um arranjo de 6 estímulos similares para 4 cores e 4 formas quando testada.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela selecionar itens por cor e forma de um arranjo de 6 estímulos similares para 2 cores e 2 formas.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança consegue discriminar como ouvinte entre as relações espaciais dos objetos no ambiente e se a criança consegue seguir instruções contendo pronomes quando solicitada a fazê-lo.',
            materiais:
              'Itens comuns encontrados no ambiente natural da criança que ela pode facilmente nomear e discriminar como ouvinte e uma lista de possíveis preposições e pronomes.',
            exemplo:
              'Quando instruída para colocar o brinquedo “dentro” da caixa ao contrário de “embaixo” da caixa, a criança consegue com sucesso repetir isso com diversos itens, Lego, caneca, tigela. Quando solicitada “Dê o brinquedo para ele”, sem olhar ou apontar, a criança é bem sucedida na discriminação entre masculino e feminino apenas por ouvir o pronome “ele” ou “ela”.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela seguir 2 instruções para cada uma das 6 preposições e para 4 pronomes diferentes.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela seguir 2 instruções com 3 preposições e 2 pronomes diferentes. Dê 1⁄2 ponto se ela seguir 2 instruções para cada uma das 6 diferentes preposições mas não para os 4 pronomes, ou vice versa. Identifique o que ela foi capaz de fazer, ou não, na seção de “comentários/ notas” do formulário de registro.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança consegue discriminar como ouvinte comparações das propriedades dos objetos, tamanho, comprimento, peso, textura e seguir instruções que envolvem comparações das propriedades das ações, velocidade, consistência, intensidade.',
            materiais:
              'Itens comuns encontrados no ambiente natural da criança que ela pode facilmente emitir como tato e discriminar como ouvinte e uma lista de possíveis adjetivos e advérbios.',
            exemplo:
              'Dado um arranjo de itens de diferentes tamanhos, ao ser indagada “Qual é o maior?” a criança seleciona o maior ou, ao escutar palavras faladas com volumes diferentes e ser indagada “Qual palavra foi falada mais alto?” a criança corretamente a identifica.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela selecionar itens de um arranjo de estímulos similares baseado na comparação de 4 pares de adjetivos e seguir instruções envolvendo a comparação de 4 pares de advérbios.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela selecionar itens de um arranjo de estímulos similares baseado na comparação de 2 pares de adjetivos e seguir 2 instruções envolvendo 2 advérbios diferentes, porém, com itens das duas categorias. Dê 1⁄2 ponto para a criança se ela discriminar como ouvinte 4 adjetivos diferentes, mas não 4 advérbios, ou vice versa. Identifique o que ela foi ou não capaz de fazer na seção de “comentários/ notas” do formulário de registro.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança consegue seguir instruções que contenham componentes múltiplos.',
            materiais:
              'Itens comuns encontrados no ambiente natural da criança que ela pode facilmente emitir como tato e discriminar como ouvinte e uma lista de possíveis instruções de 3 passos.',
            exemplo:
              '“Toque o cachorro, a vaca e o porco.” “Pegue a pena, passe cola e cole no chapéu.” “Leve sua caneca até a pia, lave e enxugue suas mãos.” “Toque o caminhão vermelho grande.” “Pegue, leve este livro para mamãe e volte aqui.” “Pegue um lenço, assoe seu nariz e jogue no lixo.”',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela seguir dez direções de 3 passos.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela seguir cinco direções de 3 passos.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar o tamanho do repertório de ouvinte da criança.',
            materiais:
              'Use livros, cenas, cartões de figuras e objetos, ações, propriedades comuns do ambiente.',
            exemplo:
              'Identifica como ouvinte muitos itens em cada página de um livro de figuras, por exemplo “Você vê alguma melancia?”.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela identificar 1200 estímulos não verbais nomes, verbos, adjetivos, advérbios, pronomes, etc. Uma lista de registro acumulada de palavras conhecidas pela criança pode ser usada se for confiável (ver comentários em TATO 15-M)',
              meioPonto:
                'Registro acumulada de palavras conhecidas pela criança pode ser usada se for confiável (ver comentários em TATO 15-M).',
            },
          },
        },
      ],
      ...
      objetivos: [
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança estabelece correspondência visual de maneira funcional em seu ambiente natural e sob controle do modelo de um colega.',
            materiais: 'Materiais básicos de arte e artesanato.',
            exemplo:
              'Um colega corta um quadrado e usa como chapéu para seu projeto de arte e a criança corta um quadrado similar e também usa como chapéu.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela espontaneamente estabelecer uma similaridade visual em uma atividade de arte ou artesanato com o modelo de um adulto ou colega 2 vezes.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela espontaneamente estabelecer uma similaridade visual com qualquer parte de uma atividade de arte ou artesanato com o modelo de um adulto ou colega 1 vez.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança adquiriu a habilidade de encontrar o par mais próximo de qualquer item. Isto é comumente referido como “repertório de emparelhamento generalizado”.',
            materiais:
              'Uma coleção de itens comuns e figuras para parear (e.g., uma banana de plástico e a figura de uma banana) e itens de comparação (muitas outras frutas).',
            exemplo:
              'Quando apresentada, pela primeira vez, a um abacaxi de plástico, e a seguir a um arranjo contendo um abacaxi, entre várias frutas e vegetais, a criança é capaz de encontrar o abacaxi na primeira tentativa, sem qualquer treino anterior com abacaxi.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela demonstrar emparelhamento generalizado não idêntico para um item novo em um arranjo desordenado de 10 itens e com 3 estímulos similares, para 25 itens.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela demonstrar emparelhamento generalizado não idêntico com um item novo em um arranjo desordenado de 10 itens e com 3 estímulos similares, para 15 itens',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança consegue completar tarefas envolvendo a montagem de itens tridimensionais a partir de cartões bidimensionais.',
            materiais:
              'Conjuntos de desenhos com blocos e outros quebra cabeças similares de formas acompanhados dos cartões modelo para a montagem.',
            exemplo:
              'Quando mostramos uma estrutura em cartão com 8 blocos de cores diferentes a criança é capaz de reproduzir exatamente o desenho com os blocos de verdade.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela completar 20 estruturas diferentes com blocos, quebra cabeças de formas ou atividades similares contendo pelo menos 8 partes diferentes.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela completar 20 estruturas diferentes com blocos diferentes, quebra cabeças de formas ou atividades similares contendo pelo menos 4 partes.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança consegue separar itens por categoria sem ser informada do nome da categoria ou do nome do primeiro item da categoria',
            materiais:
              'Figuras de diferentes itens conhecidos de uma variedade de categorias.',
            exemplo:
              'Dada uma mistura de 15 figuras de comidas, roupas e veículos, a criança é capaz de organize os itens em cada um dos grupos.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela organizar pelo menos 5 itens de 5 categorias diferentes sem um modelo ou sem o nome do primeiro item da categoria o adulto pode usar uma dica inicial do tipo “Você pode organizar isso?”.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela separar pelo menos 3 itens de 3 categorias diferentes sem um modelo ou sem o nome do primeiro item da categoria.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança consegue identificar um padrão ou sequência de estímulos demonstrando isso ao continuar este padrão sem ajuda. Exceto uma dica inicial do tipo “Você pode continuar isso?”.',
            materiais:
              'Muitos materiais comuns podem ser usados para criar padrões, abóboras, bruxas e fantasmas). Jogos de seriação, conjuntos de blocos e materiais similares que podem ser encontrados em muitas lojas educacionais ou na Web.',
            exemplo:
              'Quando é dada uma sequência de cubos coloridos do tipo vermelho, branco, azul, vermelho, branco, azul, a criança é capaz de continuar a sequência sem dicas ao selecionar as cores corretas de um arranjo de cubos coloridos.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela continuar 20 padrões de três passos, sequências ou tarefas seriadas.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela continuar 20 padrões de dois passos, sequências ou tarefas seriadas.',
            },
          },
        },
      ],
      ...
      objetivos: [
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança consegue ir além da brincadeira concreta com objetos de faz de conta que envolvam componentes criativos e novos, como brincar de assumir papéis diferentes e brincadeira simbólica.',
            materiais:
              'Brinquedos e itens encontrados na casa da criança ou no ambiente escolar que possam ser usados para brincar de faz de conta (e.g., fantasias, comida de mentira, conjunto de chá).',
            exemplo:
              'A criança finge ser um personagem como uma princesa ou um bombeiro. A criança finge que cozinha e serve o jantar.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela espontaneamente se envolver em brincadeiras de faz de conta ou imaginarias diferentes em 5 ocasiões.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela espontaneamente se envolver em brincadeira de faz de conta ou imaginária diferentes em 2 ocasiões.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança é persistente e está motivada para conseguir resultados melhores em atividades do tipo brincadeiras físicas e esportivas.',
            materiais: 'Equipamentos comuns de brincar ou de esportes.',
            exemplo:
              'A criança continua tentando acertar a bola em um buraco de mini golfe até conseguir fazer a bola entrar ou chuta uma bola até ela conseguir acertar o gol.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela repetir uma brincadeira motora grossa para obter um resultado melhor em duas atividades diferentes.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela repetir o comportamento de uma brincadeira motora grossa para obter um resultado melhor em uma atividades diferente.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança consegue permanecer na tarefa e usar itens comuns de artes e artesanato, tais como tesouras, cola, papel, giz de cera, botões, escovas, etc...para criar projetos e parece gostar destas atividades.',
            materiais: 'Suprimentos de arte e artesanato.',
            exemplo:
              'A criança desenha um rosto então recorta um nariz e cola no rosto.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se de forma independente participar de atividades do tipo artes e artesanato por 5 minutos.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se de forma independente participar de atividades do tipo artes e artesanato por 2 minutos.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança se envolve em atividades lúdicas por um período sustentado de tempo sem participação do adulto.',
            materiais:
              'Itens e brinquedos comuns encontrados na casa da criança ou ambiente escolar.',
            exemplo:
              'A criança brinca com carrinhos e garagem de carros por um período de 10 minutos. A criança brinca com Legos por alguns minutos, depois brinca com um caminhão basculante, depois com um conjunto de cozinha, totalizando 10 minutos de brincadeira contínua, tudo sem a interação com adultos.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela, de forma independente, se engajar em atividades de brincadeira contínua de forma espontânea por 10 minutos sem dicas ou reforçamento de adultos.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela, de forma independente, se engajar em atividades de brincadeira contínua de forma espontânea por 5 minutos sem dicas ou reforçamento de adultos.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança trabalha de forma independente em livros de atividades apropriados à idade e é reforçada por este tipo de atividade.',
            materiais: 'Livros infantis de tarefas pré-acadêmicas.',
            exemplo:
              'A criança complete um jogo de ligar os pontos sem a necessidade de que o comportamento seja reforçado por um adulto.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela desenhar ou escrever em livros de atividades por 5 minutos de forma independente.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela desenhar ou escrever em livros de atividades por 2 minutos de forma independente.',
            },
          },
        },
      ],
      ...
      objetivos: [
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se uma criança possui as habilidades para se envolver em comportamento cooperativo com um colega a fim de alcançar objetivo específico, sem necessidade da dica ou reforço de um adulto.',
            materiais:
              'Colegas e brinquedos ou itens encontrados na casa ou escola da criança',
            exemplo:
              'A criança e o colega cooperam um com o outro a fim de brincar em uma gangorra ou em um vagão. A criança e o colega, de forma conjunta, constroem uma torre de blocos. A criança e um colega brincam de bola.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela espontaneamente cooperar com um colega para alcançar um objetivo específico 5 vezes durante observação ou testagem (o colega pode receber uma dica para ajudar a criança, por exemplo, ajudar a carregar uma caixa).',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela espontaneamente cooperar com um colega para alcançar objetivo determinado 2 vezes durante observação ou testagem.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se uma criança vai emitir mandos por informação verbal para os colegas sem necessidade de dica ou uso de reforço por parte do adulto.',
            materiais:
              'Colegas e itens encontrados na casa ou escola da criança.',
            exemplo:
              'A criança emite mandos ao colega “Onde está o giz de cera vermelho?” (quando trabalha em um projeto de artes), ou “O que você está construindo?” (quando o colega está brincando com Legos)',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança a se ela emitir 5 mandos diferentes e espontâneos que envolvam fazer perguntas aos colegas, ou ainda outros mandos por informação em um período de uma hora.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela emitir 2 mandos diferentes e espontâneos que envolvam fazer perguntas aos colegas ou ainda outros mandos por informação em um período de uma hora.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança vai responder intraverbalmente ao comportamento verbal de um colega sem dica de adulto ou reforço.',
            materiais: 'Colegas e itens e eventos do ambiente natural.',
            exemplo:
              'Um colega emite o mando para a criança, “O que você quer construiu?” e a criança responde “Uma nave espacial”. Um colega emite o mando “O que você trouxe para o almoço?” e a criança responde “um sanduiche de pasta de amendoim”.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela responder intraverbalmente à 5 questões diferentes ou observações de colegas sem necessidade de dica do adulto ou de ser reforçada por ele durante uma observação de 1 hora ou período de testagem.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela responder intraverbalmente à 2 questões diferentes ou observações de colegas sem necessidade de dica do adulto ou de ser reforçada por ele durante uma observação de 1 hora ou período de testagem.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança participa de brincadeiras sociais e faz de conta sem dicas por um período de tempo.',
            materiais: 'Colegas e itens e eventos do ambiente natural.',
            exemplo:
              'Quando no parquinho e na a presença de várias crianças entrando e saindo de uma casinha, a criança participa da atividade: seguindo outras crianças, sentando nas cadeirinhas da casinha, bebendo algo ou dormindo de mentirinha, rindo quando outras riem, fazendo pedidos aos colegas, imitando os colegas e respondendo intraverbalmente ao comportamento verbal dos colegas.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela participar com colegas de uma brincadeira social ou atividade de faz de conta por 5 minutos.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela participar com colegas de uma brincadeira social ou atividade de faz de conta por 2 minutos.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança apresenta uma “conversação” com colegas que consista em trocas verbais de “ ida e vinda” sobre o mesmo tópico.',
            materiais: 'Colegas, itens e eventos do ambiente natural.',
            exemplo:
              'Durante uma atividade artística um colega diz “eu preciso de cola” e a criança alvo diz “aqui está”, e dá a cola para o colega. Depois que o colega usa a cola a criança alvo diz para o colega “Eu quero a cola” e o colega entrega a cola. Então o colega diz “Olha você derramou cola” e a criança alvo diz “Eu preciso de papel para limpar”. O colega pega papel e diz “Aqui está o papel para limpar”. A criança alvo diz “obrigado”.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela iniciar interação verbal ou espontaneamente responder ao comportamento verbal de um colega (com comportamento verbal relevante e adicional) e mostrar um interação verbal recíproca com 4 trocas verbais durante um período de observação de 1 hora (note que qualquer tipo de comportamento verbal conta – mandos, tatos ou intraverbal).',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela iniciar interação verbal, ou espontaneamente responder ao comportamento verbal de um colega (com comportamento verbal relevante e adicional) e mostrar um interação verbal recíproca com 2 trocas verbais durante um período de observação de 1 hora.',
            },
          },
        },
      ],
      ...
      objetivos: [
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança discrimina entre itens que parecem muito similares em um arranjo apresentado para uma tarefa de LRFFC.',
            materiais:
              'Um conjunto de objetos ou figuras conhecidos (que a criança é capaz de emitir como tato e discriminar como ouvinte) que correspondam aos alvos LRFFC e três estímulos adicionais que pareçam similares ao estímulo alvo de alguma maneira (e.g., se o estímulo alvo é um canudo e a questão é “Qual você usa para beber suco?” devem existir três itens adicionais no arranjo que se pareçam com um canudo, por exemplo, um lápis, um espeto e uma faca).',
            exemplo:
              'Se o a pergunta LRFFC for “O que você usa para se lavar?”, e o item alvo é um sabonete, o arranjo de aproximadamente 10 figuras deve conter 3 figuras que pareçam muito com o sabonete, como por exemplo, uma caixa pequena, um mini livro e um tijolinho.',
            pontuacao: {
              umPonto:
                'Se o a pergunta LRFFC for “O que você usa para se lavar?”, e o item alvo é um sabonete, o arranjo de aproximadamente 10 figuras deve conter 3 figuras que pareçam muito com o sabonete, como por exemplo, uma caixa pequena, um mini livro e um tijolinho.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela corretamente selecionar 15 itens dado este tipo de tarefa LRFFC.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança consegue responder a estímulos verbais mais complexos em um formato LRFFC. Os estímulos verbais se tornam mais complexos ao envolver duas ou mais palavras que contenham uma função, característica ou classe.',
            materiais:
              'Um conjunto de objetos ou figuras conhecidas (que a criança é capaz de emitir como tato e discriminar como ouvinte) que correspondam aos LRFFC alvo, e uma lista de funções, características e classes correspondentes para que a criança possa responder corretamente quando solicitada.',
            exemplo:
              'Peça para a criança encontrar “Um móvel marrom” ao entrar na sala de aula. Ao folhear um livro infantil sobre a Lua, solicite para a criança “Encontre algo redondo que brilha no céu”. Ao olhar para um desenho da família Simpsons pergunte para a criança, “Quem é quetem cabelo azul?”.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela corretamente selecionar 25 itens dado este tipo de tarefa LRFFC em uma figura/livro ou no ambiente natural.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela corretamente selecionar 15 itens dado este tipo de tarefa LRFFC em uma figura /livro ou no ambiente natural.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança pode responder a estímulos verbais mais complexos (uma mistura de verbos, nomes, preposições, adjetivos, ou advérbios) inseridos em um formato de pergunta e se consegue responder a arranjos não verbais que contenham múltiplos estímulos (e.g., um cenário) e estímulos que pareçam similares ao estímulo alvo.',
            materiais:
              'Use itens do ambiente natural e/ou figuras com cenários e livros (itens que criança consegue emitir como tato e discriminar como ouvinte) que correspondam aos alvos LRFFC. Também faça uma lista de adjetivos (cores, formas, tamanhos, texturas), verbos (girar, torcer, puxar, correr), preposições (sob, sobre, abaixo, acima), e advérbios (lento, rápido, quieto, barulhento) que a criança conhece pelo menos como ouvinte. Também elabore uma lista de várias combinações das diferentes partes do discurso. Note que é geralmente mais fácil primeiro achar os materiais e então arranjar as perguntas sobre os materiais.',
            exemplo:
              'Quando na sala da criança pergunte para ela “O que tem de bonito em cima da mesa?”(e. g., flores). Ao olhar uma foto de uma festa de aniversário, pergunte “Onde tem algo marrom e gelado que você come?” (e. g., sorvete de chocolate).',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela corretamente selecionar 25 itens dado este tipo de tarefa LRFFC em uma figura /livro ou no ambiente natural.',
              meioPonto:
        ...
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança consegue responder a diversas perguntas WH diferentes e alternadas sobre um único tópico quando elas são apresentadas de forma sucessiva. Cada pergunta tem uma resposta correta diferente. Esta tarefa exige que a criança atente às mudanças constantes dos múltiplos estímulos verbais.',
            materiais:
              'Um conjunto de figuras com cenas ou livros (que a criança é capaz de emitir como tato e discriminar como ouvinte) que correspondam aos LRFFC alvo. Também faça uma lista de potenciais questões WH sobre cada item na cena ou livro.',
            exemplo:
              'Quando a criança estiver brincando no quintal com um trenzinho, pergunte “Onde seu trem está indo?” (criança aponta para a ponte). “O que puxa o trem?” (criança aponta para a locomotiva). “Quem dirige o trem?” (criança aponta para o maquinista). “O que seu trem está levando?” (criança aponta para troncos em um vagão).',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela corretamente selecionar 4 itens de uma figura/livro ou no ambiente natural para para 25 tópicos diferentes apresentados neste tipo de tarefa LRFFC. Note que a criança também pode verbalizar a resposta correta ao invés de apontar para ela, o que a faz parte intraverbal e parte tato (se ela olhar para o item não verbal). Se isso ocorrer dê a ela o crédito por este marco porque a habilidade intraverbal- tato é mais avançada que a habilidade LRFFC (a menos que seja uma repetição mecânica).',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela corretamente selecionar 4 itens para 15 tópicos diferentes apresentados neste tipo de tarefa LRFFC em uma figura /livro ou no ambiente natural.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança responde a uma ampla variedade de tarefas LRFFC. Comumente neste nível a criança deve ser capaz de responder a milhares de diferentes combinações de palavras apresentadas em um formato LRFFC.',
            materiais:
              'Use materiais de livros, figuras com cenas e do ambiente natural.',
            exemplo:
              'Quando olhar um livro de figuras, faça várias perguntas LRFFC para a criança em cada página: “Onde você vê algo para dirigir?” “Com o que a menina está limpando o carro?” “O que ele está construindo?”',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela corretamente demonstrar 1000 respostas LRFFC diferentes testadas ou obtidas de uma lista acumulada de respostas conhecidas',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela corretamente demonstrar 750 respostas LRFFC diferentes testadas ou obtidas de uma lista acumulada de respostas conhecidas.',
            },
          },
        },
      ],
      ...
      objetivos: [
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança discrimina como ouvinte os números de 1 a 5 quando eles são apresentados em um arranjo misturado de 5 números.',
            materiais:
              'Os números 1-5 escritos em cartões ou qualquer outra forma.',
            exemplo:
              'A criança seleciona o número 3 em um arranjo de 5 números quando solicitada “você consegue encontrar o número 3?”',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela discriminar como ouvinte os números de 1 a 5 em um arranjo com 5 números diferentes.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela discriminar como ouvinte os números 1 a 3 em um arranjo com 3 números diferentes.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança consegue emitir tatos para os números de 1 a 5 quando eles são solicitados em uma ordem misturada, um de cada vez.',
            materiais: 'Itens e atividades comuns e apropriadas para a idade.',
            exemplo:
              'A criança emite tatos para o número 4 quando ele é apresentado com a pergunta “que número é esse?”',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela emitir tatos para os números de 1 a 5 quando eles são apresentados em uma ordem misturada, um de cada vez.',
              meioPonto:
                'Dê 1⁄2 ponto para a criança se ela emitir tatos para quaisquer 3 números.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança demonstra correspondência 1- 1 entre a contagem vocal e seu apontar (ou indicar de alguma forma) para itens até 5 unidades (dado um grupo maior de itens, a criança retira uma quantidade específica).',
            materiais: 'Itens comuns de casa ou de sala de aula.',
            exemplo:
              'A criança consegue selecionar 3 colheres de uma gaveta de utensílios quando alguém solicita “você pode me dar 3 colheres?”. A criança conta enquanto pega cada colher e para no número 3 sem qualquer ajuda.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela retirar de um conjunto maior de 1 a 5 itens quando solicitada verbalmente a fazê-lo.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela retirar de um conjunto maior de 1 a 3 itens quando solicitada verbalmente a fazê-lo.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança consegue discriminar como ouvinte entre conceitos matemáticos que envolvem comparações de tamanho, comprimento, altura, largura, volume e intensidade auditiva',
            materiais: 'Itens comuns de casa ou de sala de aula.',
            exemplo:
              'Por exemplo, quando duas pilhas de blocos diferentes (5 unidades x 10 unidades) são mostrados para a criança e alguém pergunta qual delas tem mais e menos blocos, ela seleciona consistentemente a pilha correta. Isso exemplifica duas comparações.',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela identificar como ouvinte 8 comparações diferentes envolvendo medidas.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela identificar como ouvinte 6 comparações diferentes envolvendo medidas.',
            },
          },
        },
        {
          ...
          observacoes: {
            objetivo:
              'Determinar se a criança consegue parear visualmente um número (não um número vocal) com a quantidade correta e vice versa.',
            materiais:
              'Números e itens comuns de casa ou da sala de aula ou figuras de 1 a 5 presentes em conjunto de cartões ou livros de tarefas matemáticas.',
            exemplo:
              'Quando apresentada ao número visual 3, a criança combina o número com uma figura de 3 itens ou separa 3 itens (sem quaisquer dica). De forma inversa, quando mostrado 3 itens ou a figura de 3 itens, a criança combina a figura com o número 3 (ao selecionar o 3 de um arranjo de números diferentes).',
            pontuacao: {
              umPonto:
                'Dê 1 ponto à criança se ela corretamente combinar um número escrito com uma quantidade e uma quantidade com um número escrito para os números de 1 a 5 apresentados em ordem randômica.',
              meioPonto:
                'Dê 1⁄2 ponto à criança se ela corretamente combinar um número escrito com uma quantidade e uma quantidade com um número escrito para os números de 1 a 3 apresentados em ordem randômica.',
            },
          },
        },
      ],
